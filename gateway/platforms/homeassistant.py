...
class HomeAssistantAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # Event filtering
        self._watch_domains: Set[str] = set(extra.get("watch_domains") or [])
        self._watch_entities: Set[str] = set(extra.get("watch_entities") or [])
        self._ignore_entities: Set[str] = set(extra.get("ignore_entities") or [])
